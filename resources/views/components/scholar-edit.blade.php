            ...
            <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all w-full max-w-7xl">
                ...
                <form id="edit-scholar-form" method="POST">
                    ...
                    <div class="accordion-container space-y-4">
                        <div class="border rounded-lg mt-5 border-blue-300">
                            ...
                            <div class="accordion-content p-4 hidden">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_email" class="block text-sm font-bold text-blue-700">Email</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_per_email" class="block text-sm font-bold text-blue-700">Personal Email</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_phone" class="block text-sm font-bold text-blue-700">Phone</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_emergency_contact_no" class="block text-sm font-bold text-blue-700">Emergency Contact No.</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_dob" class="block text-sm font-bold text-blue-700">Date of Birth</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_sex" class="block text-sm font-bold text-blue-700">Sex</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_caste" class="block text-sm font-bold text-blue-700">Caste</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_category" class="block text-sm font-bold text-blue-700">Category</label>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_perm_address" class="block text-sm font-bold text-blue-700">Permanent Address</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_res_address" class="block text-sm font-bold text-blue-700">Residential Address</label>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_photo" class="block text-sm font-bold text-blue-700">Photo</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_document" class="block text-sm font-bold text-blue-700">Download Document</label>
                        ...
                        <div class="border rounded-sm border-blue-300">
                            <button type="button" class="accordion-header w-full flex justify-between items-center p-4 bg-gray-50 hover:bg-gray-100 rounded-t-sm">
                            ...
                            <div class="accordion-content p-4 hidden">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_funding_agency" class="block text-sm font-bold text-blue-700">Funding Agency / Project</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_project_name" class="block text-sm font-bold text-blue-700">Project Name</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_project_id" class="block text-sm font-bold text-blue-700">Project ID</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_coPi" class="block text-sm font-bold text-blue-700">Co-PI</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_completion_date" class="block text-sm font-bold text-blue-700">Project Completion Date</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_student_file_no" class="block text-sm font-bold text-blue-700">Student File No</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_extension_date" class="block text-sm font-bold text-blue-700">Extension Date</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_srf_wef" class="block text-sm font-bold text-blue-700">SRF W.E.F</label>
                        ...
                        <div class="border rounded-sm border-blue-300">
                            ...
                            <div class="accordion-content p-4 hidden">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_type" class="block text-sm font-bold text-blue-700">Type</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_designation" class="block text-sm font-bold text-blue-700">Designation</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_fingerprint_no" class="block text-sm font-bold text-blue-700">Fingerprint No.</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_ils_id_no" class="block text-sm font-bold text-blue-700">ILS ID No</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_joining_date" class="block text-sm font-bold text-blue-700">Joining Date</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_tenure_upto" class="block text-sm font-bold text-blue-700">Tenure Upto</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_fellowship" class="block text-sm font-bold text-blue-700">Fellowship</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_registration_no" class="block text-sm font-bold text-blue-700">Registration No</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_registration_date" class="block text-sm font-bold text-blue-700">Registration Date</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_submission_date" class="block text-sm font-bold text-blue-700">Submission Date</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_award_date" class="block text-sm font-bold text-blue-700">Award Date</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_topic" class="block text-sm font-bold text-blue-700">Topic</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_no_of_publication" class="block text-sm font-bold text-blue-700">No. of Publications</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_no_of_conf_attended" class="block text-sm font-bold text-blue-700">No. of Conferences Attended</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_thesis_availability" class="block text-sm font-bold text-blue-700">Thesis Availability</label>
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_caution_money" class="block text-sm font-bold text-blue-700">Caution Money</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_hostel_joined_on" class="block text-sm font-bold text-blue-700">Hostel Joined On</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="edit_hostel_vaccated_on" class="block text-sm font-bold text-blue-700">Hostel Vacated On</label>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="mt-4">
                                        <label for="edit_correspondence" class="block text-sm font-bold text-blue-700">Correspondence</label>
