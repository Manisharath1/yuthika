...
<div id="addStaffModal" class="fixed inset-0 z-50 hidden">
    <!-- Background overlay -->
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all w-full max-w-2xl">
                ...
                <div class="text-xl font-semibold mb-6 text-gray-700">Add Staff</div>

                <form id="addStaffForm" action="{{ route('staff.index') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                    @csrf
