<x-app-layout>
                ...
                <div class=" flex-1 bg-gray-100 p-4 md:p-6" style="min-width: 50%">
                    <div class="container mx-auto">
                        ...
                        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                            ...
                            <button class="add-staff-btn w-full sm:w-auto bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">
                                Add Staff
                            </button>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <div class="dataTables_wrapper table-responsive">
                                <table id="staff-tables" class="display w-full">
                                    <thead>
                                        <tr>
                                            <th class="px-6 py-3 text-left text-xs font-medium text-blue-700 uppercase tracking-wider">Action</th>
                                            <th class="px-6 py-3 text-left text-xs font-medium text-blue-700 uppercase tracking-wider">Staff Name</th>
    ...
    <script>
        $(document).ready(function () {
            const table = $('#staff-tables').DataTable({
                responsive: true,
                scrollCollapse: true,
                pageLength: 25,
                order: [[1, 'asc']],
