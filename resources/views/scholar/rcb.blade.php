                                            ...
                                            <tr>
                                                ...
                                                @php
                                                    $formFields = [
                                                        ...
                                                        'F2' => 'f2_cert_of_reg',
                                                        'F3' => 'f3_course_work',
                                                        'F4' => 'f4_grade_statement',
                                                        'F5' => 'f5_std_adv_committee',
                                                        'F6' => 'f6_academic_transcript',
                                                        'F7' => 'f7_research_proposal',
                                                        'F8' => 'f8_progress_report',
                                                        'F9' => 'f9_phd_synopsis',
                                                        'F10' => 'f10_reco_of_SAC',
                                                        'F11' => 'f11_examiners_panel',
                                                        'F12' => 'f12_thesis_title_page',
                                                        'F13' => 'f13_student_declaration',
                                                        'F14' => 'f14_originality_cert',
                                                        'F15' => 'f15_plagiarism_cert',
                                                        'F16' => 'f16_thesis_submission',
                                                        'F17' => 'f17_inv_letter_ext_examiner',
                                                        'F18' => 'f18_lett_to_EE_conf_rept_format',
                                                        'F19' => 'f19_eval_remun_form',
                                                        'F20' => 'f20_let_to_head_with_eval_repts',
                                                        'F21' => 'f21_vivavoce_joint_rept',
                                                        'F23' => 'f23_appl_for_degree'
                                                    ];
                                                @endphp
